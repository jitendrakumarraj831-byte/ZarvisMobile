...
object OnboardingPages {
    val all = listOf(
        ...
        OnboardingPage(
            title = "Speak or type",
            body = "Tap the orb and talk, or type your task. JARVIS understands natural language — no commands to learn.",
        ),
        OnboardingPage(
            title = "Skills, not menus",
            body = "JARVIS uses specific skills to get things done — search, documents, reminders, and more, growing over time.",
        ),
        OnboardingPage(
        ...
        OnboardingPage(
            ...
            body = "You can view, export, or delete anything JARVIS remembers about you at any time from Settings.",
        ),
        OnboardingPage(
            title = "Start free",
            body = "Your trial unlocks a taste of everything JARVIS can do. Upgrade any time for more.",
        ),
    )
}
