...
// Light theme
val ZarvisSurfaceLight = Color(0xFFF4F7FF)
val ZarvisSurfaceLightElevated = Color(0xFFFFFFFF)
val ZarvisAccentIndigoLight = Color(0xFF4772FF)
val ZarvisAccentBlue = Color(0xFF4772FF)
val ZarvisAccentViolet = Color(0xFF8A5CF6)
val ZarvisAccentPink = Color(0xFFEE55A5)
val ZarvisAccentCyanLight = Color(0xFF00BFE8)
val ZarvisTextPrimaryLight = Color(0xFF17213B)
val ZarvisTextSecondaryLight = Color(0xFF68738D)
val ZarvisBorderLight = Color(0xFFDDE5F5)
