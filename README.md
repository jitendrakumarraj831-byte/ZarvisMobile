...
JARVIS MOBILE is not a chatbot, a voice-assistant shell, or a coding tool alone. It is a
...
AI_ARCHITECTURE.md      # AI provider abstraction, tool-calling loop
...
reference skills proving the pattern end-to-end. See
...
for what could not be verified in this environment (no Android SDK — see
