...
/**
 * Registers every backend-executed skill. See SKILLS.md "Current catalogue" — Research and
 * Automation are intentionally not registered here yet (foundation-only in this pass,
 * MASTER_SPEC.md §29); adding one is exactly this pattern: write the SkillDefinition,
